...
!      use CICE_MCT, only: init_mct, CICE_MCT_coupling
      use cice_coupler_mod, only: initialize_cic_coupling, &
          cic2ocn_coupling, cicfocn_coupling
#endif
...
! Need to change according to the new cice_coupler....
!      call CICE_MCT_coupling

      call cic2ocn_coupling

      call cicfocn_coupling
#endif
