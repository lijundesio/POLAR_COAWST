...
#if defined ROMS_MODEL && (defined SWAN_MODEL || defined WRF_MODEL || defined CICE_MODEL)
...
# define WRF_COUPLING
#endif
#if defined CICE_MODEL && defined ROMS_MODEL
...
# define WAVES_OCEAN
#endif
#if defined ROMS_COUPLING && defined CICE_COUPLING
# define CICE_OCEAN
#endif
...
#if defined AIR_OCEAN || defined AIR_WAVES || defined WAVES_OCEAN || defined CICE_OCEAN
