...
#endif
#ifdef CICE_OCEAN
      USE ocean_coupler_mod, ONLY : initialize_ocn2cic_coupling
      USE ocean_coupler_mod, ONLY : initialize_ocn2cic_routers
#endif
!
...
#if defined MCT_LIB && (defined AIR_OCEAN || defined WAVES_OCEAN || defined CICE_OCEAN )
!
!-----------------------------------------------------------------------
...
# ifdef CICE_OCEAN
        DO ng=1,Ngrids
          CALL initialize_ocn2cic_coupling (ng, MyRank)
        END DO
        CALL initialize_ocn2cic_routers (MyRank)
# endif
#endif
#ifdef INWAVE_MODEL
        DO ng=1,Ngrids
